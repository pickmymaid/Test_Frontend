  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="min-w-0">
        <p className="text-xs text-white/70 leading-none mb-1">{label}</p>
...
export function ContactInfoCard({
  ...
  return (
    <div
      className="rounded-3xl p-6 h-full shadow-[0px_19px_40px_0px_rgba(0,0,0,0.05)] overflow-hidden"
      style={{
        background:
          "radial-gradient(321.76% 108.33% at 4.94% 144.66%, var(--Shades-Orange-orange-600, #E86A3C) 43.13%, #FAAD62 100%)",
      }}
    >
