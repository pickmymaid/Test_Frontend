...
const PLANS = [
  {
    ...
    benefits: [
      {
        text: "Direct phone & WhatsApp access to all candidates",
        included: true,
      },
      {
        text: "Fresh verified maid & nanny profiles added daily",
        included: true,
      },
      {
        text: "Hire anyone within your 30-day unlimited access",
        included: true,
      },
      {
        text: "Unlimited maid trials & replacements until you find the right one",
        included: true,
      },
  ...
  },
  {
    ...
    benefits: [
      ...
      {
        text: "Our HR team personally picks 3 best matches for you",
        included: true,
      },
      {
        text: "Get 1 free week extra if needed within 60 days",
        included: true,
      },
      {
        text: "Unlimited maid trials & replacements until you find the right one",
  ...
  },
  {
    ...
    benefits: [
      ...
      {
        text: "Save time & effort - we'll find your perfect maid",
        included: true,
      },
      {
        text: "We shortlist, interview & arrange trials for you",
        included: true,
      },
      {
        text: "Direct phone & WhatsApp access to all candidates",
